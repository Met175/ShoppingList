...
const Errors = require("../api/errors/shoppinglist-main-error.js");
...
const logger = LoggerFactory.get("ShoppinglistMainAbl");

class ShoppinglistMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuShoppinglist",
        typeCode: "uu-shoppinglist-maing02",
        location: location,
